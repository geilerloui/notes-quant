...
> Pré-requis : [[RL Tabulaire]] (MDP, Bellman), [[Exploration (Bandits)]] (UCB1), [[Function Approximation (Deep RL)]] (réseaux profonds pour le couplage MCTS + NN).
...
> 💡 **Lien avec [[Exploration (Bandits)]].** UCB1 vient directement de la théorie des bandits — chaque enfant d'un nœud est traité comme un bras d'un bandit avec sa propre estimation et sa propre incertitude.
