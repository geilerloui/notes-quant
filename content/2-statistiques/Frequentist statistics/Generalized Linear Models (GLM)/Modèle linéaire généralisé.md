...
Le modèle linéaire gaussien (cf. [[Régression Linéaire]]) repose sur **deux hypothèses fortes** :
...
- [[Régression Linéaire]] — cas particulier identité link + Gauss
